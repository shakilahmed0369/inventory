<x-admin-layout>
    <x-slot name="heading">Edit Customer</x-slot>
    ...
    <x-admin.card title="Customer details" description="Update the information below for {{ $customer->name }}.">
        <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-5">
            ...
            <div>
                ...
                <x-admin.input id="name" name="name" type="text" :value="old('name', $customer->name)"
            ...
            <div>
                ...
                <x-admin.input id="email" name="email" type="email" :value="old('email', $customer->email)"
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <x-admin.input id="phone" name="phone" type="text" :value="old('phone', $customer->phone)"
                                   placeholder="+1 (555) 000-0000" />
                    <x-admin.input-error :messages="$errors->get('phone')" />
                </div>
                <div>
                    <x-admin.label for="address" value="Address" />
                    <x-admin.input id="address" name="address" type="text" :value="old('address', $customer->address)"
